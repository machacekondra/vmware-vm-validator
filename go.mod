module github.com/machacekondra/collector

require (
	github.com/konveyor/forklift-controller v0.0.0-20221102112227-e73b65a01cda
	github.com/kubev2v/migration-planner v0.0.0-20240814141017-2167a590f3a3
	k8s.io/api v0.30.3
...
replace github.com/vmware/govmomi => github.com/vmware/govmomi v0.34.1
